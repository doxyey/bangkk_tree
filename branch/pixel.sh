...
#device
git clone https://$MY_TOKEN@github.com/doxyey/android_device_motorola_bangkk.git -b pixel device/motorola/bangkk

#device-common
git clone https://$MY_TOKEN@github.com/doxyey/android_device_motorola_sm6375-common.git -b pixel device/motorola/sm6375-common
